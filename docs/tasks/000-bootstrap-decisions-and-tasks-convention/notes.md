...
`harness/prompts/task-brief-template.md` and always has. The original
...
(`harness/prompts/task-brief-template.md`) and updated all canonical
references (`CLAUDE.md` Related Documents, `MENTOR_BRIEF.md` §7 and §8,
`harness/init/07-create-brief.md` PASSO 5 and 6) to point there.
